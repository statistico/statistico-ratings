...
func TestRatingReader_Latest(t *testing.T) {
	...
	t.Run("returns last rating record for a team", func(t *testing.T) {
		...
		a.Equal(int64(1728), fetched.Attack.Total)
		a.Equal(int64(-3), fetched.Attack.Difference)
		a.Equal(int64(1241), fetched.Defence.Total)
		a.Equal(int64(4), fetched.Defence.Difference)
