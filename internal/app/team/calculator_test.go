...
func TestRatingCalculator_ForFixture(t *testing.T) {
	...
	t.Run("calculates new team ratings for a fixture", func(t *testing.T) {
		...
		a.Equal(175.99, newHome.Attack.Total)
		a.Equal(8.89, newHome.Attack.Difference)
		a.Equal(134.89999999999998, newHome.Defence.Total)
		a.Equal(-17.55, newHome.Defence.Difference)
		...
		a.Equal(152.45, newAway.Attack.Total)
		a.Equal(-17.55, newAway.Attack.Difference)
		a.Equal(51.34, newAway.Defence.Total)
		a.Equal(8.89, newAway.Defence.Difference)
