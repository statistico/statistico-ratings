...
func TestRatingCalculator_ForFixture(t *testing.T) {
	...
	t.Run("calculates new team ratings for a fixture", func(t *testing.T) {
		...
		a.Equal(170.91, newHome.Attack.Total)
		a.Equal(3.81, newHome.Attack.Difference)
		a.Equal(132.27999999999997, newHome.Defence.Total)
		a.Equal(-20.17, newHome.Defence.Difference)
		...
		a.Equal(149.82999999999998, newAway.Attack.Total)
		a.Equal(-20.17, newAway.Attack.Difference)
		a.Equal(46.260000000000005, newAway.Defence.Total)
		a.Equal(3.81, newAway.Defence.Difference)
