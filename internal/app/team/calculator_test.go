...
func TestRatingCalculator_ForFixture(t *testing.T) {
	...
	t.Run("calculates new team ratings for a fixture", func(t *testing.T) {
		...
		a.Equal(1233.73, newHome.Attack.Total)
		a.Equal(8.06, newHome.Attack.Difference)
		a.Equal(1236.56, newHome.Defence.Total)
		a.Equal(8.09, newHome.Defence.Difference)
		...
		a.Equal(1526.4199999999998, newAway.Attack.Total)
		a.Equal(8.09, newAway.Attack.Difference)
		a.Equal(798.78, newAway.Defence.Total)
		a.Equal(8.06, newAway.Defence.Difference)
