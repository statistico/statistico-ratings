...
func TestRatingCalculator_ForFixture(t *testing.T) {
	...
	t.Run("calculates new team ratings for a fixture", func(t *testing.T) {
		...
		a.Equal(1687.39, newHome.Attack.Total)
		a.Equal(17.39, newHome.Attack.Difference)
		a.Equal(1525.06, newHome.Defence.Total)
		a.Equal(-17.39, newHome.Defence.Difference)
		...
		a.Equal(1852.61, newAway.Attack.Total)
		a.Equal(-17.39, newAway.Attack.Difference)
		a.Equal(1659.8400000000001, newAway.Defence.Total)
		a.Equal(17.39, newAway.Defence.Difference)
